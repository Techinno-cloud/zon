...
import 'bailleur/homeBailleurs/profil/elec_cash_Eau_cash/accueilBailleur1.dart';
import 'bailleur/homeBailleurs/profil/elec_cash_Eau_cash/homeBailleur1.dart';
      ...
      Navigator.of(context).pushReplacement(
        PageRouteBuilder(
          ...
          transitionDuration: Duration(
              seconds: 3), // Durée de la transition vers la nouvelle page
        ),
      );
    });
  }
