...
class RecuBailleur extends StatefulWidget {
  const RecuBailleur({super.key});

  @override
  State<RecuBailleur> createState() => _RecuBailleurState();
}

class _RecuBailleurState extends State<RecuBailleur> {
  @override
          ...
          child: SingleChildScrollView(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                _buildCard("Historique des factures", "Détails de l'historique", Icons.history),
                SizedBox(height: screenSize.height * 0.002), // Espacement dynamique entre les cartes
                _buildCard("Historique des reçus", "Détails de l'historique", Icons.history),
                SizedBox(height: screenSize.height * 0.002),
                _buildCard("Historique des retraits", "Détails de l'historique", Icons.history),
              ],
              ),
            ),
          ),
